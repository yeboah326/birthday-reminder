...
from api.tests.data import super_user, test_user_1, test_user_2, valid_contacts
...
def create_one_test_user(client):
    # Create first user
    client.post("/api/auth/users", json=test_user_1)
...
def create_two_test_users(client):
    ...
    client.post("/api/auth/users", json=test_user_2)
